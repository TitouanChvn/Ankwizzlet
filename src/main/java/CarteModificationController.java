...
public class CarteModificationController {
    ...
    public void save(ActionEvent event) throws IOException {
        ...
        if (carte != null) { 
            ...
            //Si la carte est non nulle, mettre à jour les données de la carte
    ...
    private void next(ActionEvent event) throws IOException {
        ...
        if (carte.getId() < MyDecks.getActualDeck().deck.size()) {
            ...
            //Désactiver le bouton suivant si on est sur la dernière carte
    ...
    private void previous(ActionEvent event) throws IOException {
        ...
        if (carte.getId() > 1) {
            ...
            //Désactiver le bouton précédent si on est sur la première carte
